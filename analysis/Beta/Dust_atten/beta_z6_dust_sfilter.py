...
style_map = {
    "Cullen2023":        {"marker": "o", "color": "#1f77b4"},
    "Topping2024":       {"marker": "s", "color": "#d62728"},
    "Nanayakkara2023":   {"marker": "^", "color": "#2ca02c"},
    "Mitsuhashi2025":    {"marker": "v", "color": "#9467bd"},
    "Bouwens2014":       {"marker": "D", "color": "#8c564b"},
    "Cullen2024":        {"marker": ">", "color": "#e377c2"},
    "Bhatawdekar2021":   {"marker": "<", "color": "#7f7f7f"},
}
...
for i, z in enumerate(redshifts):
    ...
    for j, law in enumerate(dust_laws):
        ...
        # Stellar mass
        stellar_mass_m25 = np.array([g.masses['stellar'] for g in obj25.galaxies])
        stellar_mass_m50 = np.array([g.masses['stellar'] for g in obj50.galaxies])

        logM25 = np.log10(stellar_mass_m25)
        logM50 = np.log10(stellar_mass_m50)
        
        # NEW: stellar mass cut (log M* > 7.5)
        mask_25 = logM25 > 7.5
        mask_50 = logM50 > 8.5
    ...
    mask25_nd = logM25 > 7.5
    mask50_nd = logM50 > 8.5
